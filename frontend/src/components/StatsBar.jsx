function StatsBar() {
  ...
  return (
    ...
    after:absolute after:inset-x-0 after:bottom-0 after:h-5
  ...
  "
    ...
    >
      <div className="relative max-w-6xl mx-auto">
        <div className="flex items-center w-max animate-stats-scroll">
          {[...stats, ...stats].map((stat, i) => (
            <div
              key={i}
              className="
              flex flex-col items-center justify-center
              px-10 whitespace-nowrap
              leading-tight
            "
            >
              {/* ICON */}
  ...
  "
              ...
              {/* LABEL */}
              <div className="mt-0.5 text-sm text-white/80">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
